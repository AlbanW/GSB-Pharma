 ...
 */
final class Version20220325091725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenance ADD prix DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenance DROP prix, CHANGE unite unite VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
