 ...
 */
final class Version20220331100621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock DROP FOREIGN KEY FK_4B36566097F6521D');
        $this->addSql('DROP INDEX IDX_4B36566097F6521D ON stock');
        $this->addSql('ALTER TABLE stock DROP commande_produit_id, DROP stock');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock ADD commande_produit_id INT DEFAULT NULL, ADD stock INT NOT NULL');
        $this->addSql('ALTER TABLE stock ADD CONSTRAINT FK_4B36566097F6521D FOREIGN KEY (commande_produit_id) REFERENCES commande_produit (id)');
        $this->addSql('CREATE INDEX IDX_4B36566097F6521D ON stock (commande_produit_id)');
    }
}
